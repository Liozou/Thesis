...
\[\rho^\text{reciprocal}(\boldsymbol r) = \sum_{\boldsymbol l}\sum_{n=1}^N q_n\paren{\frac\alpha{\sqrt\pi}}^3\exp\paren{-\alpha^2\norm{\boldsymbol r_n + \boldsymbol l - \boldsymbol r}^2}\]
...
\\&= \frac1V\int_\Omega e^{-i\boldsymbol k\cdot\boldsymbol r} \sum_{n=1}^N q_n \paren{\frac\alpha{\sqrt\pi}}^3\exp\paren{-\alpha^2\norm{\boldsymbol r_n + \boldsymbol r}^2} \text d\boldsymbol r
\\&= \frac{2\pi\alpha^3}{V\pi^{3/2}} \sum_{n=1}^N q_n e^{-i\boldsymbol k\cdot\boldsymbol r_n} \int_0^\infty \norm{\boldsymbol{r'}}^2\exp\paren{-\alpha^2 \norm{\boldsymbol{r'}}^2}\int_0^\pi e^{-i\boldsymbol k\cdot\boldsymbol{r'}} \sin(\theta) \text d \theta \text d \boldsymbol{r'}
\\&= \frac1V\exp\paren{\frac{-k^2}{4\alpha^2}}\sum_{n=1}^N q_n e^{-i\boldsymbol k\cdot\boldsymbol r_n}\end{split}\]
...
\[\Phi^\text{reciprocal}(\boldsymbol r) = \frac{4\pi}V\sum_{\boldsymbol k\neq \boldsymbol 0}\sum_{n=1}^N \frac{q_n}{k^2} e^{i\boldsymbol k\cdot\paren{\boldsymbol r - \boldsymbol r_n}}\exp\paren{\frac{-k^2}{4\alpha^2}}\]
...
\[\Phi^\text{self}_n = \frac{2\alpha q_n}{\sqrt\pi} + \frac12\sum_{\substack{m\\m\smile n,\ m\neq n}}\frac{q_m\text{erf}\paren{\pnorm{\boldsymbol r_n - \boldsymbol r_m}}}{\pnorm{\boldsymbol r_n - \boldsymbol r_m}}\]
...
\\&+ \frac{2\pi}V \sum_{\boldsymbol k\neq 0}\sum_{n=1}^N\sum_{m=1}^N \frac{q_n q_m}{4\pi\varepsilon_0\times k^2}e^{i\boldsymbol k\cdot\paren{\boldsymbol r_m - \boldsymbol r_n}}\exp\paren{\frac{-k^2}{4\alpha^2}}
...
TODO: check $4\pi\varepsilon_0$ in reciprocal term

\subsection{Precomputation}

\subsection{Optimizations for computing the difference of energies}

\subsection{Blocking pockets}
