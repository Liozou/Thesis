...
\usepackage[
    pdfusetitle,
    pdfauthor={Lionel Zoubritzky},
    pdftitle={Methodology developments for the simulation of simple gas adsorption in nanoporous materials},
    pdfsubject={PhD thesis},
    pdfkeywords={molecular simulation, nanoporous materials, adsorption, topology, zeolites},
...
% combined with capitalize, this makes all cross-refs capitalized except sections and chapters:
...
% Skip at least one page before chapter (OnlyInMainfile), and print  after
\newcommand{\@chapterstar}[1]{
    \OnlyInMainfile{\pagestyle{empty}\null}%
    \@oldchapter*{#1}%
    \pagestyle{fancy}%
}
...
\renewcommand{\t}{\text}
\definecolor{freespeechmagenta}{RGB}{255, 58, 221}
% Boxed minipage
...
\usepackage{mathrsfs}
\newcommand{\Nleb}{\ensuremath{N_{\mathscr L}}\xspace}
...
% the following is not included since it is not a "cotutelle" but a Cifre
%\otherinstitute{Air Liquide}
%\logootherinstitute{figures/psl/airliquide.pdf}

\title{Développements méthodologiques pour la simulation de l'adsorption des gaz simples dans les matériaux nanoporeux}
\entitle{Methodology developments for the simulation of simple gas adsorption in nanoporous materials}
\author{Lionel \textsc{Zoubritzky}}
...
\begin{document}
    ...
    \selectlanguage{french}
     \epigraph{\itshape La faim est la meilleure et la plus piquante des sauces}{Chrétien \textsc{de Troyes}\\  \textsl{Yvain ou le Chevalier au Lion}}
%     \vspace{2cm}
%     \selectlanguage{english}
%     \epigraph{\itshape Times flies like an arrow; fruit flies like a banana}{Anthony \textsc{Oettinger}}
    \vfill
    \newpage
    \cleardoublepage
