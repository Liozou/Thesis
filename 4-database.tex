...
The result of isotherm fitting according to all of these models, with and without linear addition, is represented in \cref{isothermfit} on a particular example, which is the adsorption of \ce{CO2} in FAU with $\SiAl = \num{1.23}$.
...
\[\log \beta(r, T) = -22.928 - 1.8489\log r + 5170.7/T\label{eq:beta_fit_JS}\]
